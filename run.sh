...
#valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./bin/shortest-path -f datasets/test/anotherone.txt -q datasets/test/anotheroneDQ.txt
#bin/shortest-path -f datasets/test/anotherone.txt -q datasets/test/anotheroneDQ.txt

#./bin/shortest-path -f datasets/test/anotherone.txt -q datasets/test/anotheroneQ.txt
