...
#valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./bin/shortest-path -f datasets/theirExample.txt 
#./bin/shortest-path -f datasets/theirExample.txt 


#valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./bin/shortest-path -f datasets/anotherone.txt 
#./bin/shortest-path -f datasets/anotherone.txt  -q datasets/anotheroneQ.txt
